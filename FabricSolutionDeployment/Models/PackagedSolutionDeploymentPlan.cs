...
public class PackagedSolutionDeploymentPlan : DeploymentPlan {
  ...
  public List<DeploymentItem> GetDataPipelines() {
    return DeploymentItems.Where(item => item.Type == "DataPipeline").ToList();
  }
  ...
  public DeploymentSourceItem GetSourceNotebook(string DisplayName) {
    return DeployConfig.SourceItems.FirstOrDefault(item => (item.Type == "Notebook") &&
                                                           (item.DisplayName == DisplayName));
  }

  public DeploymentSourceItem GetSourceDataPipeline(string DisplayName) {
    return DeployConfig.SourceItems.FirstOrDefault(item => (item.Type == "DataPipeline") &&
                                                           (item.DisplayName == DisplayName));
  }
...
public class DeploymentConfiguration {
  ...
  public string SourceWorkspaceDescription { get; set; }
