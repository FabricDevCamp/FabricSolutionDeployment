...
public class EntraIdTokenManager {
  ...
  public static AuthenticationResult GetAccessTokenResult() {

    switch (AppSettings.AuthenticationMode) {

      case AppAuthenticationMode.ServicePrincipalAuth:
        return GetAccessTokenResultForServicePrincipal(FabricPermissionScopes.Default);

      case AppAuthenticationMode.UserAuth:
        return GetAccessTokenResultForUser(FabricPermissionScopes.TenantProvisioning);

      case AppAuthenticationMode.UserAuthWithAzurePowershell:
        return GetAccessTokenResultForAzurePowershell(FabricPermissionScopes.User_Impersonation);
  ...
  public static string GetFabricAccessTokenForUser() {
    return GetAccessTokenResultForAzurePowershell(FabricPermissionScopes.User_Impersonation).AccessToken;
  }
